...
%changelog
* Thu Jun 14 2018 RDO <dev@lists.rdoproject.org> 1:8.1.5-1
- Update to 8.1.5

* Wed Mar 07 2018 RDO <dev@lists.rdoproject.org> 1:8.1.4-1
- Update to 8.1.4

* Tue Feb 06 2018 RDO <dev@lists.rdoproject.org> 1:8.1.3-1
- Update to 8.1.3

* Wed Nov 15 2017 RDO <dev@lists.rdoproject.org> 1:8.1.2-1
- Update to 8.1.2

* Tue Sep 12 2017 rdo-trunk <javier.pena@redhat.com> 1:8.1.1-1
- Update to 8.1.1

* Wed Jul 26 2017 rdo-trunk <javier.pena@redhat.com> 1:8.1.0-1
- Update to 8.1.0

* Mon Jul 17 2017 rdo-trunk <javier.pena@redhat.com> 1:8.0.2-1
- Update to 8.0.2

* Mon Mar 13 2017 Alfredo Moralejo <amoralej@redhat.com> 1:8.0.1-1
- Update to 8.0.1

* Thu Feb 09 2017 Alfredo Moralejo <amoralej@redhat.com> 1:8.0.0-1
- Update to 8.0.0
